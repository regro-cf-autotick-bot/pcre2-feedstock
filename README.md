...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/pcre2-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/pcre2-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add pcre2 pcre2-static
# for installing globally
pixi global install pcre2 pcre2-static
```
...
It is possible to list all of the versions of `pcre2` available on your platform:
...
```
pixi search pcre2 --channel conda-forge
```
